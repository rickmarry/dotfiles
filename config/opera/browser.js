// 
/**
 ...
 **
 ** BROWSERJS_TIMESTAMP = '201830101000'; // for versioning; see DNA-54964
 **/
  ...
  (function(document) {
    ...
    */
    ...
    const version = () => {
      ...
      return `Opera OPRDesktop 28.0 core 1750.0, October 30, 2018. Active patches: ${total}`;
    ...
    const PATCHES = {
      ...
      'PATCH-1311': {
        description: 'Pretend to be Chrome on evernote',
        isMatching: () => isPartOfDomain('evernote.com'),
        apply: () => hideOperaUserAgent(),
      },
      'DNAWIZ-41887': {
        description: 'Pretend to be Chrome on sellercentral.amazon.com.tr',
        isMatching: () => isPartOfDomain('sellercentral.amazon.com.tr'),
        apply: () => hideOperaUserAgent(),
      },
      'DNA-73498': {
        description: 'Pretend to be Chrome on Computershare',
        isMatching: () => isPartOfDomain('computershare.com'),
        apply: () => hideOperaUserAgent(),
      },
      'DNAWIZ-43973': {
        description: 'Pretend to be Chrome on ABC',
        isMatching: () => isPartOfDomain('abc.go.com'),
        apply: () => hideOperaUserAgent(),
      },
      'DNA-73174': {
        description: 'Pretend to be Chrome on Scratch',
        isMatching: () => isPartOfDomain('beta.scratch.mit.edu'),
        apply: () => hideOperaUserAgent(),
      },
      'DNA-72662': {
        description: 'Pretend to be Chrome on Hulu',
        isMatching: () => isPartOfDomain('hulu.com'),
        apply: () => hideOperaUserAgent(),
      },
      'DNAWIZ-39288': {
        description: 'Pretend to be Chrome on xfinity',
        isMatching: () => isPartOfDomain('xfinity.com'),
        apply: () => hideOperaUserAgent(),
      },
      'PATCH-1303': {
